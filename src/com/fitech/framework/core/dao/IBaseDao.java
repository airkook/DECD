...
public interface IBaseDao<T, PK extends Serializable> {
    ...
    PageResults findPageByCriteria(final DetachedCriteria detachedCriteria, final int pageSize, final int pageNo)
            throws BaseDaoException;

    PageResults findPageByCriteria(final DetachedCriteria detachedCriteria, final int pageSize, final int pageNo,
            final Order orderBy) throws BaseDaoException;

    PageResults findPageByHsql(String hsql, Map paraMap, int pageSize, int pageNo) throws BaseDaoException;

    PageResults findPageBySql(String sql, Map paramMap, int pageSize, int pageNo) throws BaseDaoException;

    public PageResults findPageByHsql(Class entityClass, Map paraMap, Map orderMap, int pageSize, int pageNo)
            throws BaseDaoException;
