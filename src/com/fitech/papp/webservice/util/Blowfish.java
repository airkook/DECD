 ...
 * 包支持，用以支持Base64加密解密，用Base64的原因是由于Blowfish加密以后会产生乱码难以用URL传递
 * 
 * @author Chris
 * 
 */
...
public class Blowfish {
	...
	public static void main(String args[]) throws Exception {
		...
		System.out.println("加密以后的字符串：" + bf1.encode(str));
		System.out.println(bf1.decode("AQUA25pzVbsh1O4"));
	}
}