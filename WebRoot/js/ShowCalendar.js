...
function showCalendar(InputBox)
{
	...
	DivContent+="<td style='border-bottom:1px solid #0066FF; width:38px;background-color:#C7D8FA;font-size:12px;color:#4477FF; cursor:hand' title='清空' onClick=\"javascript:DeleteCalendar('"+name+"')\">清空</td>";
