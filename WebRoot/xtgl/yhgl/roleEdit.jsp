...
<html>
	...
	/*
		...
		*/
		...
		function saveRole(){
			...
			$('#toUpdateForm').attr("action","userManager_updateRoleInfo.action");
			$('#toUpdateForm').submit();
		}
	</script>
  </head>
  ...
  <body style="text-align: center;">
    	...
    	<p class="suoyinlan" style="text-align: left;">当前位置<span>&gt;&gt;</span>权限管理<span>&gt;&gt;</span>用户角色设置</p>
		<div class="tab_div4">
		<p style="text-align:center"><b>用户名:   ${userInfo.userName}</b></p>
		<p class="txt2"><strong>&nbsp;&nbsp;角色设置</strong></p>
		<div class="tab_div4" style="margin-left: 110px;">
		<table cellspacing="0" cellpadding="0" border="0" class="tab_content1">
		  <tr>
		    <td width="42%" align="center">角色</td>
		    <td width="13%"></td>
		  ...
		  <tr>
		    ...
		    <td align="center" valign="top">
		     <select name="selectedRoleIds" multiple="multiple" size="18" style="width:180px" id="selectRole">
		     	<c:forEach items="${haveRole}"  var="role">
		...
		<div class="tab_line" style="text-align:right">
		 ...
		 <input type="submit" class="buttonStyle3" value="返回" onClick="window.location='userManager_init.action'"/>
		</div>
		</div>
  </body>
</html>
